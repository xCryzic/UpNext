...
export interface Creator { id: number; displayName: string; username: string; bio: string; avatar: string; categories: Category[]; skills: string[]; location?: string; website?: string; lookingFor: string[]; projects: Project[]; socialAccounts: SocialAccount[]; createdAt: string; updatedAt: string; publishability: Publishability; }
